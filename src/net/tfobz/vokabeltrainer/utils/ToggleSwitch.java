...
public class ToggleSwitch extends JPanel {
    ...
    public void setToggleSwitchListener(ToggleSwitchListener listener) {
    ...
    public ToggleSwitch() {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseReleased(MouseEvent arg0) {
                ...
                // Invoke the callback when the switch is clicked
                if (toggleSwitchListener != null) {
                    toggleSwitchListener.onToggle(activated);
                }
            }
        });
